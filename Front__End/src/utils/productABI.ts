export const ProductTrackingAbi = [
  // Write functions
  ...
  // Events
  "event ProductCreated(bytes32 indexed productId, address indexed manufacturer, bytes32 metadataHash, uint256 createdAt)",

  "event TraceabilityEventAdded(bytes32 indexed productId, uint8 stepType, address indexed performedBy, bytes32 eventHash, uint256 timestamp)"
];